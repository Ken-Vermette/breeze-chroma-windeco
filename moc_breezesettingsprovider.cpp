...
#include "../../../../../../media/Storage/Development/source/breeze/kdecoration/breezesettingsprovider.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_Breeze__SettingsProvider_t, stringdata) + ofs \
...
const QMetaObject Breeze::SettingsProvider::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_Breeze__SettingsProvider.data,
      qt_meta_data_Breeze__SettingsProvider,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_Breeze__SettingsProvider.stringdata))
