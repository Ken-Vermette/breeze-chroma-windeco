...
#include "../../../../../../media/Storage/Development/source/breeze/kdecoration/breezedecoration.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_Breeze__Decoration_t, stringdata) + ofs \
...
void Breeze::Decoration::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        Decoration *_t = static_cast<Decoration *>(_o);
        switch (_id) {
        case 0: _t->init(); break;
        case 1: _t->reconfigure(); break;
        case 2: _t->recalculateBorders(); break;
        case 3: _t->updateButtonsGeometry(); break;
        case 4: _t->updateTitleBar(); break;
        case 5: _t->updateAnimationState(); break;
        default: ;
        }
    }
    Q_UNUSED(_a);
...
const QMetaObject Breeze::Decoration::staticMetaObject = {
    { &KDecoration2::Decoration::staticMetaObject, qt_meta_stringdata_Breeze__Decoration.data,
      qt_meta_data_Breeze__Decoration,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_Breeze__Decoration.stringdata))
        return static_cast<void*>(const_cast< Decoration*>(this));
